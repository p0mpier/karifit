...
<dl>
	<dt>カード番号</dt>
	<dd><input type="text" name="card_number" value="4242424242424242"></dd>
	<dt>有効期限</dt>
	<dd><input type="number" name="card_exp_month" value="12">/<input type="number" name="card_exp_year" value="21"></dd>
	<dt>カード確認コード(CVC)</dt>
	<dd><input type="text" name="card_cvc" value="123"></dd>
	<dt>お名前</dt>
	<dd><input type="text" name="card_name" value="TARO SASAKI"></dd>
</dl>
...
//公開鍵を設定
Payjp.setPublicKey("pk_test_a2bcada9309754bd7699a129");
